...
<head>
	...
	<script>
		function state() {
			...
			if (a === 'NYERI') {
				var array = ['Mathira east', 'mathira west'];
			} else if (a === 'BOMET') {
				var array = ['Bomet central', 'bomet east', 'sotik', 'chepalungu'];
			} else if (a === 'NAKURU') {
				var array = ['nakuru west', 'olenguruone', 'sach angwan', 'molo', 'subukia'];
			} else if (a === 'KERICHO') {
				var array = ['Kipkelion east', 'ainamoi', 'londiani', 'kapsoit'];
			} else if (a === 'NAROK') {
				var array = ['trans mara', 'narok west', 'narok east', 'kilgoris'];
			}
			var string = "";
...
<body>
	...
	<div class="header">
		...
		<a href="BuyerHomepage.php"><img id="logo" src="../Images/homepage/coffee_images/coffeecrop2.jpg"></a>
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<div class="carousel-item">
					<img class="images1" src="../Images/homepage/coffee_images/img.png" height="500px" width="1300px" alt="...">
				</div>
				<div class="carousel-item active">
					<img class="images1" src="../Images/homepage/coffee_images/coffeecrop2.png" height="500px" width="1350px" alt="...">
				</div>
				<div class="carousel-item">
					<img class="images1" src="../Images/homepage/coffee_images/coffeecup.jpg" height="500px" width="1350px" alt="...">
				</div>
			</div>
		</div>
	</div>
	...
	<div class=content_item><label style="font-size :30px; text-shadow: 1px 1px 1px gray;"><b>Fresh coffee</b></label></div>
	<table class="tabless">
		<tr>
	...
	<div class=content_item><label style="font-size :30px; text-shadow: 1px 1px 1px gray;"><b>Fresh coffee products</b></label></div>
	<div id="vegs">
	...
	<div class=content_item><label style="font-size :30px; text-shadow: 1px 1px 1px gray;"><b>Best coffee seeds</b></label></div>
	<div id="crops">
		<?php getCropsHomepage(); ?>
	</div>
	<hr><br>
	<div class=content_item><label style="font-size :30px; text-shadow: 1px 1px 1px gray;"><b>Best coffee Products </b></label></div><br>
	<hr>
	<div>
	...
	<div class="footer">
		...
		<div class="patym"><img src="../Images/Website/mpesa.png" height="75px" width="125px"></div>
	</div><br><br>
	<h3><span> CONNECT SOCIAL WITH US </span></h3>
	</div>
	...
	<div class="instaid">
		<div class="text"><a href="#" style="color:black;">E-coffee system</a></div>
		<div class="gmailid">
			<a href="#" class="hypher" style="color:black;">E-coffeesystem@gmail.com</a></div>
