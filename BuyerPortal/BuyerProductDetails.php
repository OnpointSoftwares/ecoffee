...
<head>
     ...
     <script>
          function state() {
               ...
               if (a === 'KERICHO') {
                    var array = ['Ainamoi', 'kipkelion'];
               } else if (a === 'BOMET') {
                    var array = ['bomet east', 'sotik'];
               } else if (a === 'NAROK') {
                    var array = ['narok west', 'narok east', 'transmara', 'kilgoris'];
               } else if (a === 'NAKURU') {
                    var array = ['rongai', 'molo', 'Sach angwan'];
               } else if (a === 'NYERI') {
                    var array = ['othaya', 'kiganjo'];
               } else if (a === 'KIAMBU') {
                    var array = ['limuru', 'kabete', 'maiu maiu'];
...
<body>
     ...
     <div class="headerdown">
          <div id="show">
               <div class="sel1 sel">
                    <button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">COFFEE VARIETIES
     ...
     <div class="instaid">
          <div class="text"><a href="#" style="color:black;"><b>E-coffee system</b></a></div>

          <div class="gmailid">
               <a href="#" class="hypher" style="color:black;">E-coffee@gmail.com</a>
          </div>
