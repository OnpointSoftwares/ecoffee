...
<head>
    ...
    <script>
        function state() {
            ...
            if (a === 'NYERI') {
                var array = ['Kieni east', 'Kieni west','Mathira east'];
            } else if (a === 'KERICHO') {
                var array = ['Kapsoit', 'Kipkelion', 'Ainamoi', 'Fort tenan', 'Bureti'];
            } else if (a === 'BOMET') {
                var array = ['Bomet central', 'Bomet east', 'S0tik', 'Chepalungu'];
            } else if (a === 'NAKURU') {
                var array = ['Olenguruone', 'Molo', 'Rongai', 'Subukia', 'Sach angwan'];
            } else if (a === 'NAROK') {
                var array = ['Trans mara', 'Kilgoris', 'Narok west', 'Narok east'];
            }
					...
					<div class="card">
						...
						<div class="card-body border border-dark">
							<form name="my-form" action="FarmerRegister.php" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="states" class="col-md-4 col-form-label text-md-right"><b><i class="fas fa-globe-americas mr-2"></i>County</b></label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="states" class="col-md-4 col-form-label text-md-right"><b><i class="fas fa-globe-americas mr-2"></i>Sub-county</b></label>
                                    <div class="col-md-6">
