...
<head>
     ...
     <script>
          function state() {
               ...
               if (a === 'kericho') {
                    var array = ['Select county', '', 'kipkelion'];
               } else if (a === 'narok') {
                    var array = ['Select county', 'emurua dikir', 'transmara'];
               } else if (a === 'Taita taveta') {
                    var array = ['Select county', 'taita taveta', 'taita north'];
               } else if (a === 'embu') {
                    var array = ['Select county', 'embu north', 'embu south'];
               } else if (a === 'nyeri') {
                    var array = ['Select county', 'othaya', 'nyeri north'];
               } else if (a === 'turkana') {
                    var array = ['Select county', 'turkana north *', 'kapenguria'];
               } else if (a === 'Garissa') {
                    var array = ['Select county', 'Garissa', 'garissa township'];
               } else if (a === 'Wajir') {
                    var array = ['Select county', 'wajir', 'wajir town', 'wajir township'];
               } else if (a === 'kilifi') {
                    var array = ['Select county', 'kilifi', 'kilifi east *', 'kilifi west'];
               } else if (a === 'nakuru') {
                    var array = ['Select county', 'nakuru east', 'rongai'];
               } else if (a === 'makueni') {
                    var array = ['Select county', 'makueni *', 'makueni west'];
               } else if (a === 'Lamu') {
                    var array = ['Select District', 'lamu *', 'lamu east'];
               } else if (a === 'west pokot') {
                    var array = ['Select county', 'west pokot'];
               } else if (a === 'bungoma') {
                    var array = ['Select county', 'bungoma', 'kimilili'];
               } else if (a === 'Busia') {
                    var array = ['Select county', 'busia'];
               } else if (a === 'kitui') {
                    var array = ['Select county', 'kitui east '];
               } else if (a === 'machakos') {
                    var array = ['Select county', 'machakos'];
               } else if (a === 'laikipia') {
                    var array = ['Select county', 'laikipia'];
               } else if (a === 'homa bay') {
                    var array = ['Select county', 'homa bay *'];
               } else if (a === 'mandera') {
                    var array = ['mandera *'];
               } else if (a === 'nandi') {
                    var array = ['Select county', 'nandi', 'kapsabet '];
               } else if (a === 'vihiga') {
                    var array = ['Select county', 'vihiga'];
               } else if (a === 'tharaka nithi') {
                    var array = ['Select county', 'North ', 'West', 'South', 'East'];
               } else if (a === 'kwale') {
                    var array = ['Select county', 'kwale'];
               } else if (a === 'siaya') {
                    var array = ['Select county', 'siaya','bondo *'];
                    //check
               } else if (a === 'kisumu') {
                    var array = ['Select county', 'kisumu', 'kisumu east', 'kisumu central'];
               } else if (a === 'kiambu') {
                    var array = ['Select county', 'Kiambu', 'thika', 'kabete upper', 'ruiru'];
               } else if (a === 'nairobi') {
                    var array = ['Select county', 'Nairobi ', 'Embakasi ', 'langata *', 'kabete '];
               } else if (a === 'mombasa') {
                    var array = ['Select county', 'Mombasa*'];
               } else if (a === 'kajiado') {
                    var array = ['Select county', 'kajiado', 'kajiado south', 'kajiado north', 'kitenegela*'];
               } else if (a === 'baringo') {
                    var array = ['Select county', 'baringo north'];
               } else if (a === 'kakamega') {
                    var array = ['Select county', 'kakamega *', 'North   *', 'lugari  *', 'East   *', 'South  *'];
               } else if (a === 'bomet') {
                    var array = ['Select county', 'Bomet', 'Chamoli', 'kaplong *', 'sotik', 'silibwet'];
               }
               ...
               <div class="row   p-2">
                    ...
                    <div class="col-6 col-xl-3 col-lg-3 col-md-6 col-sm-6 p-0 States">
                         ...
                         <select class="p-2 shadow-lg" id="states" name="stateInput" onchange="state()" tabindex="1" style="border-radius: 6px; margin-right:  200px; border-color:#FFD700 ">
                              ...
                              <option valu="KAJIADO">KAJIADO</option>
                              <option value="MACHAKOS">MACHAKOS</option>
                              <option value="KITUI">KTUI</option>
